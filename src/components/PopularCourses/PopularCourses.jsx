            ...
            <div className="top">
                ...
                <div className='info'>
                    ...
                    <div className="arrows">
                        <div className="left">
                            <img src="/udujar/images/left.svg" alt="" />
                        </div>
                        <div className="right">
                            <img src="/udujar/images/right.svg" alt="" />
                        </div>
                    </div>
                </div>
            </div>
